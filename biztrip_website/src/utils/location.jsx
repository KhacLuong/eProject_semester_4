...
export const ManagementCoachListPage = lazy(() => import("../pages/admin/management_coaches/ManagementCoachList.jsx"))
export const CoachListPage = lazy(() => import("../pages/admin/coaches/CoachList.jsx"))
